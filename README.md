# Film Awards
[🔗 Film Awards](https://ayoung-j.github.io/search-movies/)<br />
TMDB 오픈 API를 이용해 영화 리스트를 보여주고 검색할 수 있는 사이트입니다.<br /><br />
...
12. 키보드 enter키를 입력해도 검색버튼 클릭한 것과 동일하게 검색 실행시키기<br /><br />
